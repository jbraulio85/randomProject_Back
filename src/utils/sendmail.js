...
sendMail(req, user, project, res, callback) {
    ...
    const mailOptions = {
        ...
        text: `Hola ${user.name}, tu proyecto es ${project.name}, el repositorio del mismo es ${project.repository}`,
        html: `<p>Hola ${user.name},</p><p>tu proyecto es <strong>${project.name}</strong>, el repositorio del mismo es ${project.repository}</p>`
    };
